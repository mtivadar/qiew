...
class FsNtfs(FileFormat):
    ...
    def init(self, viewMode, parent):
        ...
        print hex(file_record_size)

        for i in range(16):
            self._viewMode.selector.addSelection((start_mft + i*file_record_size, start_mft + i*file_record_size + file_record_size, QtGui.QBrush(QtGui.QColor(125, 175, 150)), 0.3), type=TextSelection.SelectionType.IF_CURSOR_IN_RANGE)
